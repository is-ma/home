...
alias od="unset VISUAL; bash ~/is-ma/home/generators/opencode/gen_for_deepseek.sh >/dev/null 2>&1; opencode"
alias og='unset VISUAL; bash ~/is-ma/home/generators/opencode/gen_for_go.sh >/dev/null 2>&1; opencode'
